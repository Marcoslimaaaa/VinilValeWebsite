        ...
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                <Mail className="w-5 h-5 mr-3 pool-blue-400" />
                <span className="text-gray-300">contato@vinilvale.com</span>
              </div>
              <div className="flex items-center">
                <Phone className="w-5 h-5 mr-3 pool-blue-400" />
                <span className="text-gray-300">(11) 99999-9999</span>
              </div>
              <div className="flex items-center">
                <MapPin className="w-5 h-5 mr-3 pool-blue-400" />
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-pool-blue-500 transition-colors"
              >
